...
function JsonForm(props) {
	...
	const checkString = (parentkey, item, value) => {
		return <TextField onChange={handleChange} name={parentkey} label={item} variant="outlined" value={value} type={'text'} />
	}

	// Generate Number Field
	const checkNumber = (parentkey, item, value) => {
		return <TextField onChange={handleChange} name={parentkey} label={item} variant="outlined" value={value} type={'number'} />
	}
